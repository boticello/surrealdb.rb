...
RSpec.describe SurrealDB::BoundIncluded do
  ...
  it "supports equality" do
    ...
    expect(described_class.new(5)).not_to eq(SurrealDB::BoundExcluded.new(5))
  end
end
...
RSpec.describe SurrealDB::BoundExcluded do
  ...
  it "supports equality" do
    ...
    expect(described_class.new(10)).not_to eq(described_class.new(11))
    expect(described_class.new(10)).not_to eq(SurrealDB::BoundIncluded.new(10))
  end
end
